...
import (
	...
	"belajar-golang-retsful-api/model/domain"
...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root:acumalaka@tcp(localhost:3306)/belajar_golang_restful_api_test")
...
func TestUnauthorized(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories", nil)
	request.Header.Add("X-API-KEY", "ACUMALAKA")
